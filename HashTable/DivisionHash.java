...
public class DivisionHash {
	 ...
	 public static void main(String[] args) {
		// prompt user for input
	        ...
	        // read data from file and insert into hash table using division hash function
	        ...
	        try {
	            ...
	            writer.println("Method: Division");
	            ...
	            //	System.out.println("Modular divisor is: 120");
	            	//System.out.println("Bucket Size: 3");
	                for (int i = 0; i < divisor; i++) {
